...
# Fake Voice Detection Model for Public Figures
Implementation of Anon and Payap's Fake Voice Detection Model for Public Figures (98.33% accuracy after Equal Error Rate (EER) tuning by Evaluation set).
